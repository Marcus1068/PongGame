...
#ifndef PINGPONGRETRO_SWIFT_H
#define PINGPONGRETRO_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PingPongRetro",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSCoder;
@class SKView;
SWIFT_CLASS("_TtC13PingPongRetro9PongScene")
...
@class UITouch;
@class UIEvent;
@interface PongScene (SWIFT_EXTENSION(PingPongRetro))
